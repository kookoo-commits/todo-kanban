  ...
  return (
    <DialogPortal>
      ...
      <DialogPrimitive.Content
        ...
        className={cn(
          "dialog-panel fixed top-1/2 left-1/2 z-50 grid -translate-x-1/2 -translate-y-1/2 gap-4 rounded-xl bg-paper p-5 shadow-overlay",
      ...
      >
        ...
        <DialogPrimitive.Close
          className="pressable focus-ring absolute top-3 right-3 inline-flex size-11 items-center justify-center rounded-md text-muted hover:bg-surface hover:text-ink"
          aria-label="닫기"
        >
          <X className="size-4" />
        </DialogPrimitive.Close>
